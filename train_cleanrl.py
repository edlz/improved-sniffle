"""
train_cleanrl.py — CleanRL-style single-file PPO for Fire Emblem: Thracia 776

Based on https://github.com/vwxyzjn/cleanrl/blob/master/cleanrl/ppo.py

Usage:
    python train_cleanrl.py
    python train_cleanrl.py --total-timesteps 20000000
    python train_cleanrl.py --checkpoint checkpoints/cleanrl_ppo/latest.pt
"""
