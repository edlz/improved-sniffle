"""
eval_cleanrl.py — evaluate a CleanRL checkpoint with pygame rendering + RAM log

Usage:
    python eval_cleanrl.py
    python eval_cleanrl.py --checkpoint checkpoints/cleanrl_ppo/latest.pt
    python eval_cleanrl.py --deterministic false
"""
...
from train_cleanrl import Agent, make_env, Args as TrainArgs
